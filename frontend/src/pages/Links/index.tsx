...
export default function LinksPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Payment Links"
        subtitle="PPV links generated by chatters — card details never touch this system."
        actions={
          <>
      ...
      <StatGrid>
        ...
        <StatCard label="Revenue" value={<Money amount={revenue} />} sub="from paid links" up />
      </StatGrid>
        ...
        <div className="pl-fees">
          <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 10 }}>
            ...
            <span
              style={{
                color: fb
                  ? fb.effectivePct >= 18 ? 'var(--red)'
                    : fb.effectivePct >= 15 ? 'var(--amber)'
                      : 'var(--brand)'
                  : 'var(--muted)',
              }}
            >
